const getStaticPromptsList = (index, prompt) => {
    return [
        //0
        `Create a colorful, full screen, "${prompt}" template. Return nested json objects. 
    ...
    The children property is always and array of more html objects. Write professional headlines and subheadlines and paragraph copy.
    Use full page design, professional typ0graphy, Engaging copy, Use picsum images. Use multicolor, ui/ux. Only return only valid json. The response should pass JSON.parse()`,
        //1  input, select, textarea,
        `Create a full page "${prompt}" layout. Return a nested json object. 
        Objects contain required properties: name, keywords, description, attributes, css, elementType. 
        Objects contain optional children array and attributes object as properties. 
    ...
    The css property is a detailed css string. 
    The textContent property is the value for text elements.
    STYLE EVERY ELEMENT WITH COHESIVE THEME. 
    The children property is an array of same nested html objects. 
    Write a extra super large typographic heading.
    Use picsum image full page background images. studio-quality, marketing quality, production-ready. Only return only valid json. The response should pass JSON.parse()`,
    //2
